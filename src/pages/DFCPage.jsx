...
export default function DFCPage({ data }) {
  ...
  return (
    <div className="flex flex-col gap-6">
      ...
      <div className="grid grid-cols-4 gap-4">
        <KPI label="Índice de Liquidez de Caixa" value={indiceLiquidezCaixa != null ? `${indiceLiquidezCaixa.toFixed(2)}x` : "—"} tone={indiceLiquidezCaixa != null && indiceLiquidezCaixa >= 1 ? "positive" : "negative"} sub="Caixa ÷ Contas a Pagar em aberto (proxy)" />
      </div>
